...
def create_tempmap(date, data_dir=home+'SDO_data/',
    ...
    for wl, wlen in enumerate(wlens):
        ...
        if temp_im == []:
            ...
            qr = client.query(vso.attrs.Time(date,
                                             date + dt.timedelta(seconds=12)),
        ...
        temp_im.data /= temp_im.exposure_time
...
class TemperatureMap(GenericMap):
    def __init__(self, date=None, data_dir=None, maps_dir=None, 
                 fname=None):
        ...
        try:
            ...
            data, meta, fit = create_tempmap(date, data_dir, maps_dir)
